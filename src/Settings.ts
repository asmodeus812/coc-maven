...
export class Settings {
    ...
    public static readonly External = class {
    ...
    public static readonly Terminal = class {
        ...
        public static favorites(project: MavenProject): FavoriteCommand[] | undefined {
            ...
            return _getMavenSection<Favorite[]>("terminal.favorites", coc.Uri.file(project.pomPath))?.map(
                (favorite) => new FavoriteCommand(project, favorite.command, favorite.alias, favorite.debug)
            );
        }
    };
    public static readonly Executable = class {
    ...
    public static readonly Pomfile = class {
     ...
     */
    public static getExploreProjectName(project: { pomPath?: string; artifactId: string; groupId: string; version: string; name: string }) {
